...
public class Test2 {
  ...
  public static void main(String[] args) {
    ...
    while (true) {
      int userchoice = scan1.nextInt();//读取数字符
      if (userchoice == 0) { //输入0，结束循环
        break;
      }
      if (userchoice == 1) { //功能二  展示有向图
        ...
        System.out.printf("\n");
      } else if (userchoice == 3) { //根据bridge word生成新文本
        ...
        if (dist[p1][p2] == INF) {
          ...
          System.out.printf("The shortest path between “%s” and “%s” is %s ,include: %s",
              word3, word4, dist[p1][p2], shortword);
          System.out.printf("\n");
        }
